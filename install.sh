...
bash <(curl -Ls https://raw.githubusercontent.com/omidcrfx/Nethogs-Json-main/master/install.sh --ipv4)
...
wait
sudo sed -i "s/9221/$port/g" /var/www/html/cp/Config/database.php &
wait
